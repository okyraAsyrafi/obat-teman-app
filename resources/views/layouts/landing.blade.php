    ...
    <nav id="navbar-default" class="bg-white border-gray-200 ">
        <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
            ...
            <button data-collapse-toggle="navbar-default" type="button"
                class="inline-flex items-center p-2 w-10 h-10 justify-center text-sm text-gray-500 rounded-lg md:hidden hover:bg-teal-100 focus:outline-none focus:ring-2 focus:ring-gray-200   dark:focus:ring-gray-600"
    ...
    <section id="hero-section" class="bg-gradient-to-r from-teal-50 via-white to-teal-50 py-12 md:py-16">
        <div class="mx-auto grid max-w-screen-xl px-4 pb-8 md:grid-cols-12 lg:gap-12 lg:pb-16 xl:gap-0">
            <div class="content-center justify-self-start md:col-span-7 md:text-start">
                <span
                    class="bg-teal-100 text-green-800 text-xs font-medium me-2 px-2.5 py-0.5 rounded-sm  dark:text-teal-400 border border-green-400">Sistem
                ...
                <button type="button"
                    class="text-white bg-teal-700 hover:bg-teal-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center me-2 dark:hover:bg-teal-700">
            ...
            <div class="space-y-8 md:grid md:grid-cols-2 lg:grid-cols-3 md:gap-12 md:space-y-0">
                <div class="max-w-sm p-8 bg-white border border-gray-200 rounded-lg shadow-sm  ">
                    <div class="flex flex-col items-center text-center">
                        <span
                            class="inline-flex items-center justify-center w-16 h-16 mb-4 text-sm font-semibold text-teal-800 bg-teal-100 rounded-full  dark:text-gray-300">
